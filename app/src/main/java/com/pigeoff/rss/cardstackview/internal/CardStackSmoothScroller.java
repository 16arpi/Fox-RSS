...
public class CardStackSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    protected void onTargetFound(
        ...
        com.pigeoff.rss.cardstackview.internal.AnimationSetting setting;
        switch (type) {
            case AutomaticSwipe:
    ...
    protected void onStart() {
        ...
        com.pigeoff.rss.cardstackview.internal.CardStackState state = manager.getCardStackState();
        switch (type) {
            case AutomaticSwipe:
                state.next(com.pigeoff.rss.cardstackview.internal.CardStackState.Status.AutomaticSwipeAnimating);
                listener.onCardDisappeared(manager.getTopView(), manager.getTopPosition());
                break;
            case AutomaticRewind:
                state.next(com.pigeoff.rss.cardstackview.internal.CardStackState.Status.RewindAnimating);
                break;
            case ManualSwipe:
                state.next(com.pigeoff.rss.cardstackview.internal.CardStackState.Status.ManualSwipeAnimating);
                listener.onCardDisappeared(manager.getTopView(), manager.getTopPosition());
                break;
            case ManualCancel:
                state.next(com.pigeoff.rss.cardstackview.internal.CardStackState.Status.RewindAnimating);
    ...
    private int getDx(com.pigeoff.rss.cardstackview.internal.AnimationSetting setting) {
        com.pigeoff.rss.cardstackview.internal.CardStackState state = manager.getCardStackState();
        int dx = 0;
