...
import com.pigeoff.rss.cardstackview.internal.CardStackSetting;
import com.pigeoff.rss.cardstackview.internal.CardStackSmoothScroller;
import com.pigeoff.rss.cardstackview.internal.CardStackState;
import com.pigeoff.rss.cardstackview.internal.DisplayUtil;
...
public class CardStackLayoutManager
    ...
    private com.pigeoff.rss.cardstackview.CardStackListener listener = com.pigeoff.rss.cardstackview.CardStackListener.DEFAULT;
    public CardStackSetting setting = new CardStackSetting();
    private CardStackState state = new CardStackState();

    public CardStackLayoutManager(Context context) {
        this(context, com.pigeoff.rss.cardstackview.CardStackListener.DEFAULT);
    }

    public CardStackLayoutManager(Context context, com.pigeoff.rss.cardstackview.CardStackListener listener) {
    ...
    private void update(RecyclerView.Recycler recycler) {
        ...
        if (state.isSwipeCompleted()) {
            ...
            final com.pigeoff.rss.cardstackview.Direction direction = state.getDirection();
             ...
             *
             * 2019-03-31 18:44:29.744 8496-8496/com.pigeoff.rss.cardstackview.sample E/AndroidRuntime: FATAL EXCEPTION: main
             *     Process: com.pigeoff.rss.cardstackview.sample, PID: 8496
             *     java.lang.IllegalStateException: Cannot call this method while RecyclerView is computing a layout or scrolling com.pigeoff.rss.cardstackview.CardStackView{9d8ff78 VFED..... .F....ID 0,0-1080,1353 #7f080027 app:id/card_stack_view}, adapter:com.pigeoff.rss.cardstackview.sample.CardStackAdapter@e0b8651, layout:com.pigeoff.rss.cardstackview.CardStackLayoutManager@17b0eb6, context:com.pigeoff.rss.cardstackview.sample.MainActivity@fe550ca
             ...
             *         at com.pigeoff.rss.cardstackview.sample.MainActivity.paginate(MainActivity.kt:164)
             *         at com.pigeoff.rss.cardstackview.sample.MainActivity.onCardSwiped(MainActivity.kt:50)
             *         at com.pigeoff.rss.cardstackview.CardStackLayoutManager.update(CardStackLayoutManager.java:277)
             *         at com.pigeoff.rss.cardstackview.CardStackLayoutManager.scrollHorizontallyBy(CardStackLayoutManager.java:92)
    ...
    private void updateOverlay(View view) {
        ...
        com.pigeoff.rss.cardstackview.Direction direction = state.getDirection();
