...
import com.pigeoff.rss.cardstackview.internal.CardStackDataObserver;
import com.pigeoff.rss.cardstackview.internal.CardStackSetting;
import com.pigeoff.rss.cardstackview.internal.CardStackSnapHelper;
...
public class CardStackView extends RecyclerView {
    ...
    public void swipe(Direction direction) {
        ...
        if (getLayoutManager() instanceof CardStackLayoutManager) {
            CardStackLayoutManager manager = (CardStackLayoutManager) getLayoutManager();
            CardStackSetting setting = manager.setting;
            SwipeAnimationSetting swipeAnimationSetting = setting.swipeAnimationSetting;
            swipeAnimationSetting.setSwipeDirection(direction);
